...
## Usage: Simply download `Colab-DeepMosaics.ipynb` and open it inside your Google Drive or click [here](https://colab.research.google.com/github/leohab75/DeepMosaics/blob/master/Colab_DeepMosaics.ipynb) and copy the file with "File > Save a copy to Drive..." into your Google Drive.

# Info about Colab
- If you can't open `Colab-DeepMosaics.ipynb` inside your Google Drive, try this [colab link](https://colab.research.google.com/github/leohab75/DeepMosaics/blob/master/Colab_DeepMosaics.ipynb) and save it to your Google Drive. The "open in Colab"-button can be missing in Google Drive, if that person never used Colab.
